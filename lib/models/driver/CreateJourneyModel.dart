class CreateJourneyModel {
  ...
  CreateJourneyModel.fromJson(dynamic json) {
    code = json['code'];
    status = json['status'];
...
class Data {
  Data({
      this.currentJurneyCar,});

  Data.fromJson(dynamic json) {
    if (json['currentJurneyCar'] != null) {
      currentJurneyCar = [];
      json['currentJurneyCar'].forEach((v) {
        currentJurneyCar?.add(CurrentJurneyCar.fromJson(v));
      });
    }
  }
  List<CurrentJurneyCar>? currentJurneyCar;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (currentJurneyCar != null) {
      map['currentJurneyCar'] = currentJurneyCar?.map((v) => v.toJson()).toList();
    }
    return map;
  }
...
class CurrentJurneyCar {
  ...
  CurrentJurneyCar.fromJson(dynamic json) {
    id = json['id'];
    carId = json['car_id'];

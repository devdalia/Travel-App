...
class DepositsPackagesWidget extends StatefulWidget {
  DepositsPackagesWidget({Key? key}) : super(key: key);

  @override
  State<DepositsPackagesWidget> createState() => _DepositsPackagesWidgetState();
}

class _DepositsPackagesWidgetState extends State<DepositsPackagesWidget> {
  bool click = false;
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  CustomTextWidget(
                    title: 'Sold_money_without_any_additional_expenses_anywhere_in_Egypt_and_Palestine'.tr,
